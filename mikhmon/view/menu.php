...
<div class="sidenav unselect">
 ...
 <!--  <div class="sidenav_item tooltip">
    ...
    &nbsp;
    <span id="statconn" class="tooltiptext-right hide"></span>
  </div> -->
...
<div class="navbar" id="mnav">
  <a id="mactive"><?php if($page == ""){echo $navicon. " Dashboard";}else{echo $navicon." ".ucfirst($page);} ?></a>
  ...
  <a href="#" class="<?= $quickprint_ma ?>" ><i class="fa fa-print"></i> Quick Print</a>
  ...
  <a href="javascript:void(0);" style="font-size:15px;" class="nav_icon" onclick="mNav()"><i class="fa fa-bars"></i></a>
</div>
...
<div class="navbar" id="mnav">
  <a id="mactive"><?php if($page == ""){echo $navicon. " Dashboard";}else{echo $navicon." ".ucfirst(str_replace("_"," ",$page));} ?></a>
