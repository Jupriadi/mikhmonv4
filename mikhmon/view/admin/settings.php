                ...
                <?php if(isset($_GET['r']) && !empty($_GET['r'])){
                    foreach (file('./config/config.php',FILE_SKIP_EMPTY_LINES) as $line) {
                      ...
                      if ($ss == $_GET['r']) {
                          ...
                          $areload = get_config($line,$_GET['r'].'*', "'");
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <select id="idleTo" class="form-control asave pointer" >
                                            <option value="<?= $idleto; ?>"><?php echo $idleto; if($idleto != "disable"){echo " minutes";} ?> </option>
                                    ...
                                    <div class="card-sq">
                                      ...
                                      <div class="card-body">
                                        <form action="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                          ...
                                          <?= $upmess ?>
                                          <div class="btn bg-btn-group" id="browsefile" ><i class="fa fa-search"></i> Browse File</div>
...
<div class="row">
  <div class="col-12">
            ...
            <div class="col-12 mr-b-10">
                <div class="col-10"><h3><span  id="pload"><i class="fa fa-gear"></i> Settings</span></h3></div>
                <div class="col-2">
                <div class="dropdown">
                    ...
                    <table class="table table-bordered table-hover">
                        <tbody>
                            ...
                            if ($s == "" || $s == "mikhmon") {
                                ...
                                <tr>
                                  <td><i class="fa fa-wifi" id="<?= $s; ?>p"></i> <b> <?= $hn; ?></b><span style="float:right;">[<?= $i ?>]</span> <br>
                                  Session Name: <?= $s; ?><br>
                      ...
                      if ($ss == $_GET['r']) {
                          ...
                          <div class="col-12 hide" id="edit-router">
                            ...
                            <div class="row">
                              <div class="col-12">
                                <div class="btn-group">
                                  <button class="bg-btn-group" onclick="location.replace('./?admin/settings')"><i class="fa fa-close" ></i></button>
                                  <button class="bg-btn-group" onclick="removeRouter('<?= $_GET['r']; ?>')"><i class="fa fa-trash" ></i> Remove</button>
                                  <button class="bg-btn-group" id="saveR" ><i class="fa fa-save" ></i> Save</button>
                                  <button class="bg-btn-group" id="rConnect" ><i class="fa fa-plug" ></i> Connect </button>
                                </div>
